...
try:
    ...
    set_motor_speed(1, 1)    # Set speeds to 0.5 = 50%
    time.sleep(4)
    
    print("Motors 3 & 4 reverse")
    control_motors(False, True)  # Both motors backward
    set_motor_speed(1, 1)     # Set speeds to 1 == 100%
    time.sleep(5)
      
    print("Motors 3 & 4 reverse")
    control_motors(True, True)  # Both motors backward
    set_motor_speed(1, 1)     # Set speeds to 1 == 100%
    time.sleep(4)
